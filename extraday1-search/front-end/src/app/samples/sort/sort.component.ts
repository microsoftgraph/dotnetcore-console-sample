...
export class SortComponent implements OnInit {
  ...
  selectedASCSortPropertiesList:string[] = [
    "Created",
    "Summary"
  ]
...
executeSearch1(input:string){
  ...
  var intersection:string[] = this.selectedASCSortPropertiesList.filter( x=> this.selectedDESCSortPropertiesList.indexOf(x) > -1);
  ...
  this.commonService.Search(this.searchInput1, this.entityTypes, this.selectedASCSortPropertiesList).subscribe(data=>{
    this.data = data;
